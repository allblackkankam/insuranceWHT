! function(o, r, p) {
    ...
    if (p(o).scroll(function() {
            ...
            }), p('a[data-action="close"]').on("click", function() { p(this).closest(".card").removeClass().slideUp("fast") }), setTimeout(function() { p(".row.match-height").each(function() { p(this).find(".card").not(".card .card").matchHeight() }) }, 500), p('.card .heading-elements a[data-action="collapse"]').on("click", function() {
                var e, a = p(this).closest(".card");
            ...
            var n = d.data("menu");
            "horizontal-menu" != n && !1 === a && p(".main-menu-content").find("li.active").parents("li").addClass("open"), "horizontal-menu" == n && (p(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), p(".main-menu-content").find("li.active").parents("li").addClass("active")), p(".heading-elements-toggle").on("click", function() { p(this).next(".heading-elements").toggleClass("visible") });
            var t = p(".chartjs"),
            ...
            p(".custom-file input").change(function(e) { p(this).next(".custom-file-label").html(e.target.files[0].name) }), p(".char-textarea").on("keyup", function(e) {
                ! function(e, a) {
                    ...
                    var t;
                    p(".char-count").html(e.value.length), e.value.length > n ? (p(".counter-value").css("background-color", u), p(".char-textarea").css("color", u), p(".char-textarea").addClass("max-limit")) : (p(".counter-value").css("background-color", "#5A8DEE"), p(".char-textarea").css("color", "#304156"), p(".char-textarea").removeClass("max-limit"))
                }(this, e), p(this).addClass("active")
            }), p(".content-overlay").on("click", function() { p(".search-list").removeClass("show"), p(".app-content").removeClass("show-overlay"), p(".bookmark-wrapper .bookmark-input").removeClass("show") });
            var l = r.getElementsByClassName("main-menu-content");
            0 < l.length && l[0].addEventListener("ps-scroll-y", function() { 0 < p(this).find(".ps__thumb-y").position().top ? p(".shadow-bottom").css("display", "block") : p(".shadow-bottom").css("display", "none") })
        }), p(r).on("click", ".sidenav-overlay", function(e) { return p.app.menu.hide(), !1 }), "undefined" != typeof Hammer) {
        var e = r.querySelector(".drag-target");
        if (0 < p(e).length) new Hammer(e).on("panright", function(e) { if (d.hasClass("vertical-overlay-menu")) return p.app.menu.open(), !1 });
        setTimeout(function() {
            var e, a = r.querySelector(".main-menu");
            0 < p(a).length && ((e = new Hammer(a)).get("pan").set({ direction: Hammer.DIRECTION_ALL, threshold: 100 }), e.on("panleft", function(e) { if (d.hasClass("vertical-overlay-menu")) return p.app.menu.hide(), !1 }))
        }, 300);
        var a = r.querySelector(".sidenav-overlay");
        if (0 < p(a).length) new Hammer(a).on("panleft", function(e) { if (d.hasClass("vertical-overlay-menu")) return p.app.menu.hide(), !1 })
    }
    p(r).on("click", ".menu-toggle, .modern-nav-toggle", function(e) { return e.preventDefault(), p.app.menu.toggle(), setTimeout(function() { p(o).trigger("resize") }, 200), 0 < p("#collapsed-sidebar").length && setTimeout(function() { d.hasClass("menu-expanded") || d.hasClass("menu-open") ? p("#collapsed-sidebar").prop("checked", !1) : p("#collapsed-sidebar").prop("checked", !0) }, 1e3), p(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").hasClass("show") && p(".vertical-overlay-menu .navbar-with-menu .navbar-container .navbar-collapse").removeClass("show"), !1 }), p(".navigation").find("li").has("ul").addClass("has-sub"), p(".carousel").carousel({ interval: 2e3 }), p(".nav-link-expand").on("click", function(e) { "undefined" != typeof screenfull && screenfull.enabled && screenfull.toggle() }), "undefined" != typeof screenfull && screenfull.enabled && p(r).on(screenfull.raw.fullscreenchange, function() { screenfull.isFullscreen ? (p(".nav-link-expand").find("i").toggleClass("bx-exit-fullscreen bx-fullscreen"), p("html").addClass("full-screen")) : (p(".nav-link-expand").find("i").toggleClass("bx-fullscreen bx-exit-fullscreen"), p("html").removeClass("full-screen")) }), p(r).ready(function() {
        ...
        0 < e.length && e[0].addEventListener("ps-scroll-y", function() { 0 < p(this).find(".ps__thumb-y").position().top ? p(".shadow-bottom").css("display", "block") : p(".shadow-bottom").css("display", "none") })
    }), p("#sidebar-page-navigation").on("click", "a.nav-link", function(e) {
        e.preventDefault(), e.stopPropagation();
        var a = p(this),
            n = a.attr("href"),
            t = p(n).offset().top - 80;
        p("html, body").animate({ scrollTop: t }, 0), setTimeout(function() { a.parent(".nav-item").siblings(".nav-item").children(".nav-link").removeClass("active"), a.addClass("active") }, 100)
        ...
        i18next.changeLanguage(t, function(e, a) { p(".main-menu").localize() })
    });
    var h = p(".search-input input").data("search");
    p(".bookmark-wrapper .bookmark-star").on("click", function(e) {
        e.stopPropagation(), p(".bookmark-wrapper .bookmark-input").toggleClass("show"), p(".bookmark-wrapper .bookmark-input input").val(""), p(".bookmark-wrapper .bookmark-input input").blur(), p(".bookmark-wrapper .bookmark-input input").focus(), p(".bookmark-wrapper .search-list").addClass("show");
        var a = p("ul.nav.navbar-nav.bookmark-icons li"),
            n = "";
        p("ul.search-list li").remove();
        for (var t = 0; t < a.length; t++) n += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === t ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + a[t].firstChild.href + '><div class="d-flex justify-content-start"><span class="mr-75 ' + a[t].firstChild.firstChild.className + '"  data-icon="' + a[t].firstChild.firstChild.className + '"></span><span>' + a[t].firstChild.dataset.originalTitle + '</span></div><span class="float-right bookmark-icon bx bx-star warning"></span></a></li>';
        p("ul.search-list").append(n)
    }), p(".nav-link-search").on("click", function() {
        p(this);
        p(this).parent(".nav-search").find(".search-input").addClass("open"), p(".search-input input").focus(), p(".search-input .search-list li").remove(), p(".search-input .search-list").addClass("show"), p(".bookmark-wrapper .bookmark-input").removeClass("show")
    }), p(".search-input-close i").on("click", function() {
        p(this);
        var e = p(this).closest(".search-input");
        e.hasClass("open") && (e.removeClass("open"), p(".search-input input").val(""), p(".search-input input").blur(), p(".search-input .search-list").removeClass("show"), p(".app-content").hasClass("show-overlay") && p(".app-content").removeClass("show-overlay"))
        ...
        if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            27 == e.keyCode && (p(".app-content").removeClass("show-overlay"), p(".bookmark-input input").val(""), p(".bookmark-input input").blur(), p(".search-input input").val(""), p(".search-input input").blur(), p(".search-input").removeClass("open"), p(".search-list").hasClass("show") && (p(this).removeClass("show"), p(".search-input").removeClass("show")));
            var s = p(this).val().toLowerCase(),
                o = "",
                i = !1;
            if (p("ul.search-list li").remove(), p(this).parent().hasClass("bookmark-input") && (i = !0), "" != s) {
                p(".app-content").addClass("show-overlay"), p(".bookmark-input").focus() ? p(".bookmark-input .search-list").addClass("show") : (p(".search-input .search-list").addClass("show"), p(".bookmark-input .search-list").removeClass("show")), !1 === i && (p(".search-input .search-list").addClass("show"), p(".bookmark-input .search-list").removeClass("show"));
                var l = "",
                    r = "",
                    c = "",
                    d = "",
                ...
                p.getJSON("../../../app-assets/data/" + h + ".json", function(e) {
                    ...
                    for (a = 0; a < e.listItems.length; a++) {
                        ...
                        0 != e.listItems[a].name.toLowerCase().indexOf(s) && -1 < e.listItems[a].name.toLowerCase().indexOf(s) && u < 10 && (r += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === u ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + d + "</a></li>", u++)
                    }
                    "" == l && "" == r && (r = '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100"><div class="d-flex justify-content-start"><span class="mr-75 bx bx-error-circle"></span><span>No results found.</span></div></a></li>'), c = l.concat(r), p("ul.search-list").html(c)
                })
            } else if (!0 === i) {
                for (var a = p("ul.nav.navbar-nav.bookmark-icons li"), n = "", t = 0; t < a.length; t++) 0 === t ? "current_item" : "", n += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href=' + a[t].firstChild.href + '><div class="d-flex justify-content-start"><span class="mr-75 ' + a[t].firstChild.firstChild.className + '"  data-icon="' + a[t].firstChild.firstChild.className + '"></span><span>' + a[t].firstChild.dataset.originalTitle + '</span></div><span class="float-right bookmark-icon bx bx-star warning"></span></a></li>';
                p("ul.search-list").append(n)
    ...
    }), p(r).on("mouseenter", ".search-list li", function(e) { p(this).siblings().removeClass("current_item"), p(this).addClass("current_item") }), p(r).on("click", ".search-list li", function(e) { e.stopPropagation() }), p("html").on("click", function(e) { p(e.target).hasClass("bookmark-icon") || (p(".bookmark-input .search-list").hasClass("show") && p(".bookmark-input .search-list").removeClass("show"), p(".bookmark-input").hasClass("show") && p(".bookmark-input").removeClass("show")) }), p(r).on("click", ".bookmark-input .search-list .bookmark-icon", function(e) {
