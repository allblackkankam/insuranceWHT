...
$send = 1;
$firstnameErr=$lastnameErr=$usernameErr=$mailErr=$passErr=$re_passErr=$contactErr=$roleErr=$oldpasswordErr="";
$firstname=$lastname=$username=$mail=$pass=$re_pass=$contact=$role=$oldpassword="";
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    if($_POST["action"]=="0"){
        ...
        $errObject = array("name"=>"$usernameErr","action"=>"");
