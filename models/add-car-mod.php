...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	if($send==1){
		$query = "INSERT INTO addcar (d_name, d_number, c_make, c_number,c_model,c_color,c_pic,user_id,date_added)
		VALUES('$d_name', '$d_number', '$c_make', '$c_number', '$c_model','$c_color','$savedname','$user_id', now()) ";
