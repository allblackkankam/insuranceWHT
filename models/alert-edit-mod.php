...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $a_id =mysqli_real_escape_string($conn,test_input($_POST['a_id']));
	...
	if($send==1){
		$query = "UPDATE alert SET a_name='$a_name', a_means='$a_means', a_info='$a_info', a_car='$a_car',a_num='$a_num',a_model='$a_model'
		WHERE a_id = $a_id ";
