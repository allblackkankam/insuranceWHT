...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $aff_id =mysqli_real_escape_string($conn,test_input($_POST['aff_id']));
	...
	if($send==1){
		$query = "UPDATE aff SET aff_name='$aff_name', aff_num='$aff_num', aff_mail='$aff_mail', aff_pos='$aff_pos',aff_loc='$aff_loc' WHERE aff_id = $aff_id ";
