...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $c_id =mysqli_real_escape_string($conn,test_input($_POST['c_id']));
	...
	{   
        if(!empty($_FILES["c_pic"]["name"])){ 
            ...
            if(move_uploaded_file($c_pic_temp, "../app-assets/images/cars/$savedname")){
                ...
                $query = "UPDATE carreg SET c_num='$c_num', c_make='$c_make' , c_model='$c_model', c_vin='$c_vin', c_tyre='$c_tyre',c_tyrenum='$c_tyrenum',c_engine='$c_engine',c_enginenum='$c_enginenum',c_color='$c_color',c_info='$c_info',o_name='$o_name',o_num='$o_num',o_lic='$o_lic',i_com='$i_com',i_type='$i_type',i_num='$i_num',c_pic='$savedname',added= now() WHERE c_id= $c_id ";
                ...
                $query = "UPDATE carreg SET c_num='$c_num', c_make='$c_make' , c_model='$c_model', c_vin='$c_vin', c_tyre='$c_tyre',c_tyrenum='$c_tyrenum',c_engine='$c_engine',c_enginenum='$c_enginenum',c_color='$c_color',c_info='$c_info',o_name='$o_name',o_num='$o_num',o_lic='$o_lic',i_com='$i_com',i_type='$i_type',i_num='$i_num',added= now() WHERE c_id= $c_id ";
